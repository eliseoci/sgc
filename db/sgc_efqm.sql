...
(123, 'TEST 1 Liderazo'),
(124, 'TEST 1 LIDERAZGO'),
(125, 'Test 3 Estrategia'),
(126, 'EWEFW'),
(127, '1221EWQE'),
(128, '¿Han sido definidos por parte del Equipo Directivo la Misión, la Visión, los Principios Éticos y Valores que conforman la "Cultura" de la Universidad, y han sido convenientemente divulgados a todos los Grupos de Interés (profesores, alumnos, Personal de Administración y Servicios (PAS), Consejo Social, etc.)?'),
(129, '¿Incluyen dichos valores conceptos tales como calidad y aprendizaje?'),
(130, 'El comportamiento del Equipo Directivo ¿es coherente con dichos valores?'),
(131, '¿Impulsa la Gerencia el desarrollo e implantación de un Sistema de Gestión por Procesos que permita traducir la Estrategia/Presupuesto a objetivos cuantificables que, medidos de forma periódica, sirvan para mejorar los resultados globales?'),
(132, '¿Se relaciona el Equipo Directivo con los profesores, alumnos, socios y representantes de la sociedad para conocer sus necesidades y expectativas?'),
(133, '¿Se implican y apoyan actividades de mejora, protección medioambiental o de contribución a la sociedad?'),
(134, '¿Mantiene el Equipo Directivo una comunicación fluida y bidireccional con sus empleados?'),
(135, '¿Aprovechan dicha comunicación para transmitir los Valores y las Estrategias de la Universidad? '),
(136, '¿Escuchan las aportaciones y/o quejas de sus empleados? '),
(137, '¿Apoya el Equipo Directivo a sus empleados y les ayudan si es necesario para conseguir sus objetivos? '),
(138, '¿Les animan y facilitan la participacion en equipos/actividades de mejora?'),
(139, '¿Reconocen adecuadamente a individuos o equipos por su contribución a dichas actividades?'),
(140, '¿Define e impulsa el Equipo Directivo los cambios necesarios para adecuar la Universidad? '),
(141, '¿Garantizan la inversión, los recursos y el apoyo necesarios para desarrollar dichos cambios? '),
(142, '¿Una vez producidos los cambios, se mide la eficacia de los mismos y se comunican a los Grupos de Interés?'),
(143, 'En la definición del Plan Operativo/Presupuesto Anual de la Unidad Organizativa, ¿se recogen y consideran las Necesidades y Expectativas de los diferentes Grupos de Interés (empleados de la propia Unidad, estudiantes, potenciales estudiantes, PDI, PAS, centros, departamentos, órganos de gobierno, Admones. Públicas e instituciones conveniadas), así como datos sobre el comportamiento del sistema universitario y unidades similares?'),
(144, 'En la definición del Plan Operativo/Presupuesto Anual de la Unidad Organizativa, ¿se recogen y consideran los resultados de las mediciones anteriores, tanto propios como de unidades similares, y se analizan los impactos de la legislación aplicable, la innovación tecnológica, y los indicadores socioeconómicos y demográficos a corto y largo plazo?'),
(145, 'En la definición del Plan Operativo/Presupuesto Anual de la Unidad Organizativa, ¿se tienen en cuenta: Coherencia con los Principios Éticos y Valores que conforman su "Cultura"?'),
(146, 'En la definición del Plan Operativo/Presupuesto Anual de la Unidad Organizativa, ¿se tienen en cuenta: Atención equilibrada de necesidades y expectativas de los Grupos de Interés.?'),
(147, 'En la definición del Plan Operativo/Presupuesto Anual de la Unidad Organizativa, ¿se tienen en cuenta: Análisis de Riesgos y Plazos e identificación de los Factores Críticos de Éxito?'),
(148, '¿Se identifican los Procesos Clave de la Unidad Organizativa y se despliega el Plan Operativo a través de ellos? '),
(149, '¿Se descomponen los Objetivos y Metas de la Unidad Organizativa a través de los distintos niveles, llegando hasta la definición y seguimiento de los objetivos individuales o de equipo?'),
(150, '¿Se evalúa el nivel de conocimiento y sensibilización de los Grupos de Interés sobre los aspectos fundamentales de la Estrategia, Plan Operativo y Presupuesto, según sea apropiado?'),
(151, '¿Existe un Plan específico de Personal de Administración y Servicios, respetuoso con la legislación vigente y la igualdad de oportunidades, alineado con la Estrategia y el Plan Operativo de la Universidad, y se revisa conjuntamente con ellos? '),
(152, '¿Se tienen en cuenta las opiniones del Personal de Administración y Servicios en la definición de dicho Plan?'),
(153, '¿Se preocupa el Equipo Directivo del desarrollo personal y profesional del Personal de Administración y Servicios, procurando la adecuación de sus conocimientos y experiencia a las necesidades derivadas de su responsabilidad? '),
(154, '¿Se desarrollan e implantan planes de formación que faciliten dicha adecuación? '),
(155, '¿Se asigna al Personal de Administración y Servicios objetivos individuales y de equipo, y se evalúa su rendimiento?'),
(156, '¿Estimula el Equipo Directivo la implicación del PAS hacia la consecución de sus objetivos, mediante la motivación y el reconocimiento? '),
(157, '¿Promueve y facilita el Equipo Directivo la participación del PAS en acciones de mejora?'),
(158, '¿Impulsa y motiva al PAS hacia la innovación y la creatividad, siendo receptiva a sus aportaciones y sugerencias de mejora?'),
(159, '¿Se preocupa el Equipo Directivo de establecer una buena comunicación con/entre sus empleados?'),
(160, '¿Se han desarrollado cauces de comunicación verticales y horizontales y se utilizan eficientemente?'),
(161, '¿Se aprovechan dichos canales de comunicación para difundir el conocimiento y las buenas prácticas?'),
(162, '¿Se asegura el Equipo directivo del alineamiento de sus políticas de remuneración, movilidad, etc., con el Plan Operativo y Presupuesto? '),
(163, '¿Existe una política de reconocimiento hacia el PAS y fomento de la concienciación en temas medioambientales y de seguridad e higiene? '),
(164, '¿Se proporciona al PAS unas instalaciones y servicios de alta calidad?  '),
(165, '¿Existe sensibilidad ante necesidades personales/clientes?  '),
(166, '¿Identifica la Unidad Organizativa aquellas Organizaciones clave con las que se relaciona (Universidades, administraciones públicas, proveedores, etc.)?'),
(167, '¿desarrolla con ellas acuerdos de colaboración, fomentando la transferencia de conocimientos y el aprovechamiento de sinergias?'),
(168, '¿Se ha definido e implantado una estrategia económico-financiera, alineada con la Estrategia/Plan Operativo de la Unidad Organizativa y traducida en un Presupuesto Anual? '),
(169, '¿Contempla dicha estrategia tanto las inversiones previstas, como los recursos necesarios para la financiación de las actividades de la Unidad Organizativa? '),
(170, '¿Contempla una adecuada gestión del riesgo financiero, gestión de cobros (cuando proceda), etc.? '),
(171, '¿Se asegura la Unidad Organizativa del adecuado funcionamiento, conservación y seguridad de sus edificios e instalaciones? '),
(172, '¿Se optimizan recursos, inventarios y se reducen consumos de suministros y energías (principalmente, los no renovables)? '),
(173, '¿Se cuidan adecuadamente los aspectos medioambientales y de reciclado de residuos?'),
(174, '¿Identifica la Unidad Organizativa las tecnologías e instalaciones más adecuadas para cubrir sus necesidades y las de sus clientes?'),
(175, '¿Gestiona adecuadamente las tecnologías existentes y se preocupa de su actualización y renovación?'),
(176, '¿Recoge y gestiona adecuadamente la Unidad Organizativa toda la información pertinente para el cumplimiento de sus fines? '),
(177, '¿Facilita a sus Grupos de Interés el acceso a las informaciones que son de su interés?'),
(178, '¿Protege adecuadamente la información sensible, tanto para la gestión como para las personas?'),
(179, '¿La Facultad dispone y aplica una metodología de procesos orientada a la identificación, diseño y documentación de sus Procesos Clave, que son aquéllos considerados imprescindibles para desplegar y desarrollar la Estrategia y Plan Operativo? '),
(180, '¿Dicha metodología de procesos se corresponde con alguna estandarización del tipo ISO 9000 propia de la Universidad o similar?'),
(181, '¿Disponen los Procesos, y en especial los denominados Clave, de unos sistemas de medición o indicadores, que permitan establecer sus objetivos de rendimiento y evaluar los resultados obtenidos? '),
(182, '¿Se han identificado aquellas áreas de los procesos que son comunes con otras unidades y a agentes externos a éste (proveedores, administración, etc.)? '),
(183, '¿Se revisa regularmente la eficiencia de los Procesos y se modifican apropiadamente en función de dichas revisiones, así como en función de las informaciones procedentes de sugerencias de mejora, actividades de aprendizaje, propuestas de innovación, etc.? '),
(184, 'La implantación de los cambios en los Procesos, ¿se realiza mediante un análisis previo (piloto) y una adecuada comunicación/formación a todos los implicados?'),
(185, '¿Se recogen informaciones procedentes de estudios de mercado y competencia, necesidades y expectativas de clientes, sugerencias innovadoras y creativas..., ?'),
(186, '¿se tiene en cuenta esta informacion a la hora de definir los nuevos Productos, Servicios y actividades de la Unidad organizativa?'),
(187, '¿Se investigan las necesidades y expectativas, así como el grado de satisfacción de los clientes con los Productos y Servicios, y se utiliza dicha información para la modificación y mejora de los mismos?'),
(188, '¿Se asegura la Unidad organizativa de que las características y prestaciones de los Productos y Servicios que proporciona a sus clientes responden a las especificaciones de su diseño? '),
(189, '¿Comunica veraz y adecuadamente la Unidad organizativa las condiciones de prestación de sus Productos y Servicios a sus potenciales clientes? '),
(190, '¿Establece niveles de compromiso y es consecuente con los mismos?'),
(191, '¿Desarrolla la Unidad organizativa actividades encaminadas a identificar necesidades y expectativas de sus clientes? '),
(192, '¿Dispone la Unidad organizativa de cauces de comunicación para la recepción de quejas y reclamaciones de sus clientes? '),
(193, '¿Tramita las mismas de forma sistemática y utiliza dicha información para la mejora permanente de sus servicios?'),
(194, '¿Identifica la Universidad cuáles son los aspectos más significativos y que más aprecian sus clientes? '),
(195, '¿El método que se utiliza para identificar dichos aspectos es fiable, se revisa de forma periódica y permite segmentar los resultados en función de los diferentes grupos de clientes?'),
(196, '¿Obtiene periódicamente los Servicios de la Universidad información directa del grado de satisfacción de los diferentes grupos de clientes respecto a dichos aspectos más significativos, así como de los servicios recibidos, y el nivel de satisfacción global?'),
(197, 'Sobre los indicadores del grado de satisfacción de clientes, ¿se marcan objetivos y se miden los resultados obtenidos? '),
(198, '¿La tendencia de dichos indicadores es positiva? '),
(199, 'Si en alguno no lo fuera, ¿se han averiguado las causas y establecido las acciones de mejora adecuadas?'),
(200, '¿Se comparan los índices de satisfacción de clientes con los de los Servicios en otras Universidades? '),
(201, 'Respecto a dichos indicadores, ¿en qué situación competitiva situamos a la Universidad?'),
(202, 'Teniendo en cuenta cuáles son los aspectos más valorados por los clientes, ¿ha identificado la Universidad con qué procesos están relacionados y con qué indicadores de dichos procesos puede existir una correspondencia?'),
(203, 'Sobre los indicadores de dichos procesos, que inciden directamente en la satisfacción de los clientes, ¿se marcan objetivos y se miden los resultados obtenidos? '),
(204, '¿La tendencia de dichos indicadores es positiva? '),
(205, 'Si en alguno no lo fuera, ¿se han averiguado las causas y establecido las acciones de mejora adecuadas?'),
(206, '¿Se comparan los resultados de dichos indicadores con los de otras Universidades o el propio sector? '),
(207, 'Respecto a dichos indicadores, ¿en qué situación competitiva situamos a los Servicios de la Universidad?'),
(208, '¿Obtiene periódicamente la Facultad información directa del grado de satisfacción de los diferentes grupos de empleados respecto a aquellos aspectos que les son más significativos, así como del nivel de satisfacción global?'),
(209, 'Sobre los indicadores del grado de satisfacción de los empleados, ¿se marcan objetivos y se miden los resultados obtenidos? '),
(210, '¿La tendencia de dichos indicadores es positiva? '),
(211, 'Si en alguno no lo fuera, ¿se han averiguado las causas y establecido las acciones de mejora adecuadas?'),
(212, '¿Se comparan los índices de satisfacción de los empleados con los de otras Unidades o Universidades? '),
(213, 'Respecto a dichos indicadores, ¿en qué situación competitiva situamos a la Unidad Organizativa?'),
(214, '¿Ha identificado la Facultad con qué procesos están relacionados los índices de satisfacción de los empleados, y con qué indicadores de dichos procesos puede existir una correspondencia?'),
(215, 'Sobre los indicadores de dichos procesos, que inciden directamente en la satisfacción de los empleados, ¿se marcan objetivos y se miden los resultados obtenidos? '),
(216, '¿La tendencia de dichos indicadores es positiva? '),
(217, 'Si en alguno no lo fuera, ¿se han averiguado las causas y establecido las acciones de mejora adecuadas?'),
(218, '¿Se comparan los resultados de dichos indicadores con los de otras unidades de la propia Universidad y/o Universidades? '),
(219, 'Respecto a dichos indicadores, ¿en qué situación situamos a la Unidad Organizativa?'),
(220, '¿Identifica y mide la Unidad Organizativa el nivel de percepción que tiene la Sociedad respecto a aquellos aspectos de especial sensibilidad social en su esfera de influencia? '),
(221, '¿La tendencia de dichos indicadores es positiva? '),
(222, 'Si en alguno no lo fuera, ¿se han averiguado las causas y establecido las acciones de mejora adecuadas?'),
(223, '¿Ha identificado la Unidad Organizativa con qué procesos están relacionados los índices de percepción social, y con qué indicadores de dichos procesos puede existir una correspondencia?'),
(224, '¿Se marcan objetivos sobre dichos indicadores y se miden los resultados obtenidos? '),
(225, '¿La tendencia de dichos indicadores es positiva? '),
(226, 'Si en alguno no lo fuera, ¿se han averiguado las causas y establecido las acciones de mejora adecuadas?'),
(227, '¿Se comparan los índices de percepción social de la Unidad Organizativa con los de otras Unidades de la propia Universidad o con Unidades Organizativas similares y de Universidades líderes? '),
(228, 'Respecto a dichos indicadores, ¿en qué situación competitiva situamos a la Unidad Organizativa?'),
(229, '¿Define objetivos y mide la Unidad Organizativa de forma periódica y sistemática sus Resultados Clave, y especialmente los económico-financieros?'),
(230, '¿Los objetivos son cada vez más exigentes y los resultados muestran una tendencia positiva? '),
(231, 'Si alguno de los Resultados Clave no reflejara una tendencia positiva, ¿se han averiguado las causas y establecido las acciones de mejora adecuadas?'),
(232, '¿Se comparan los Resultados Clave con los de otras unidades organizativas o  universidades? '),
(233, 'Respecto a dichos indicadores de Resultados Clave, ¿en qué situación competitiva situamos a la Unidad Organizativa?'),
(234, 'Además de dichos Resultados Clave, ¿define objetivos y mide la Facultadde forma periódica y sistemática otros resultados correspondientes a procesos de soporte, que contribuyen de manera sustancial a la consecución de los anteriores?'),
(235, 'Los objetivos de dichos indicadores correspondientes a procesos de soporte, ¿son cada vez más exigentes y los resultados muestran una tendencia positiva?'),
(236, 'Si alguno de los resultados no reflejara una tendencia positiva, ¿se han averiguado las causas y establecido las acciones de mejora adecuadas?'),
(237, '¿Se comparan los resultados de los indicadores de procesos de soporte con los de otras Unidades Organizativas o Universidades? '),
(238, 'Respecto a dichos indicadores, ¿en qué situación competitiva situamos a la Unidad Organizativa?');
